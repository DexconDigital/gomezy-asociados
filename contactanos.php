                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12 ">
                            <div class="d-flex" style="margin-left: 25%;">
                                ...
                                <div style="width:35px; height:35px;" class="hover_iconos align-items-center d-flex justify-content-center mr-4 border border-light text-center rounded-pill"> <a href="<?php echo $redes_sociales['twitter']['link']  ?>" target="_blank"><i style="font-size:18px;" class="<?php echo $redes_sociales['twitter']['icono'] ?>"></i></a></div>
